...
# text 적기
game_font = pygame.font.Font(None, 40) # 폰트 객체를 생성하고 폰트와 크기를 지정한다

# 게임 시간 적기
total_time = 10

# 시작 시간 정보 저장
start_ticks = pygame.time.get_ticks() # 시작 tick을 받아온다
...
while running:
    ...
    # 경과 시간(ms단위)을 1000으로 나누어서 초 단위로 표시 
